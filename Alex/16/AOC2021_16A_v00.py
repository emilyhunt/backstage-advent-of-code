...
#Functions
def process_packet(unprocessed_transmission_binary,versionsum):
    ...
    if typeID == "100":
        ...
        if lengthIDtype == "0":
            ...
            while bits_processed < bits_toprocess:
                [versionsum,unprocessed_transmission_binary] = process_packet(unprocessed_transmission_binary,versionsum)
    ...
    return versionsum, unprocessed_transmission_binary
