...
#Build Larger Risk Map
#pdb.set_trace()
riskmapnew = riskmap
riskmapnew = np.append(riskmapnew,riskmap+1,axis=0)
riskmapnew = np.append(riskmapnew,riskmap+2,axis=0)
riskmapnew = np.append(riskmapnew,riskmap+3,axis=0)
riskmapnew = np.append(riskmapnew,riskmap+4,axis=0)
riskmapnewnew = riskmapnew
riskmapnewnew = np.append(riskmapnewnew,riskmapnew+1,axis=1)
riskmapnewnew = np.append(riskmapnewnew,riskmapnew+2,axis=1)
riskmapnewnew = np.append(riskmapnewnew,riskmapnew+3,axis=1)
riskmapnewnew = np.append(riskmapnewnew,riskmapnew+4,axis=1)

riskmap = riskmapnewnew

for x,rows in enumerate(riskmap):
    for y, risk in enumerate(rows):
        if risk >9:
            riskmap[x][y] -= 9
